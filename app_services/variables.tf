...
variable "always_on" {
  description = "Disable cold start"
  type        = bool
}
...
variable "env_classification_tag" {
  type        = string
...
variable "subscription_id" {
  description = "target subscription id for the deployment"
  type        = string 
}

variable "tenant_id" {
  description = "target tenant id for the deployment"
  type        = string
}